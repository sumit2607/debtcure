...
def replace_loader(directory):
    ...
    for file_path in html_files:
        ...
        new_content = re.sub(r'<!-- Full Screen Shimmer Loader -->.*?(?=<header)', NEW_LOADER, content, flags=re.DOTALL)
